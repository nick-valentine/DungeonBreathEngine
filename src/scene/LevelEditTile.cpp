#include "LevelEditTile.h"

#define TILE_SIZE 64
#define CAMERA_LAG 10

namespace scene {
    LevelEditTile::LevelEditTile(sf::Vector2i size, std::string tileset) : Scene(size), tileset(tileset), last_input(core::Input::num_keys, false)
    {
    ...
    void LevelEditTile::update(int delta, sf::RenderWindow &window)
    {
    ...
    void LevelEditTile::draw(sf::RenderWindow &window)
    {
    ...
    int LevelEditTile::get_selected()
    {
        return current_selected;
    }

    Scene::Status LevelEditTile::status()
    {
        return this->state;
    }

    Scene *LevelEditTile::new_scene()
    {
        return this->next_scene;
    }

    void LevelEditTile::reset_status()
    {
        this->state = Scene::Status::nothing;
        this->next_scene = nullptr;
    }

    void LevelEditTile::update_selected()
    {
        auto i = 0;
