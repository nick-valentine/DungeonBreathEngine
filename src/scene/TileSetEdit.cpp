...
namespace scene {
    ...
    TileSetEdit::TileSetEdit(sf::Vector2i size, std::string tileset) : Scene(size),
        state(Scene::nothing),
        next_scene(nullptr),
        inner_state(editing),
    ...
    void TileSetEdit::update(int delta, sf::RenderWindow &window)
    {
    ...
    void TileSetEdit::draw(sf::RenderWindow &window)
    {
        window.draw(spr);
    ...
    Scene::Status TileSetEdit::status()
    {
        return state;
    }

    Scene *TileSetEdit::new_scene()
    {
        return next_scene;
    }

    void TileSetEdit::update_editing(int delta, sf::RenderWindow &window)
    {
    ...
    void TileSetEdit::update_menu(int delta, sf::RenderWindow &window)
    {
    ...
    void TileSetEdit::draw_editing(sf::RenderWindow &window)
    {
    ...
    void TileSetEdit::draw_menu(sf::RenderWindow &window)
    {
        menu.draw(window);
    }

    void TileSetEdit::place_marker()
    {
        markers.push_back(
            TileMarker(
                base_size,
    ...
    void TileSetEdit::load_tile_set()
    {
    ...
    void TileSetEdit::save_tile_set()
    {
        auto filename = TILESETDIR + tileset + ".txt";
    ...
    std::string TileSetEdit::grouped_anim_tile(int id)
    {
    ...
    void TileSetEdit::delete_markers()
    {
        for (size_t i = 0; i < markers.size(); ++i) {
